...
func init() {
	parse.Register("catalog.BodyModifier", modifierFromJSON)
}
...
func NewModifier(b []byte, contentType string) *BodyModifier {
...
func (m *BodyModifier) SetBoundary(boundary string) {
	m.boundary = boundary
}
